  ...
  <div class="jcjs common-card-wrap"
        ...
        <div class="content">
          <div class="action clear">
            ...
            <el-select v-model="selectValue" filterable clearable placeholder="请选择状态"
                       size="mini" @keyup.enter.native="searchHandle" @change="queryTableData($event,'select')">
              <el-option
          ...
          <div class="table-list">
            <el-table :data="table.tableData" border style="width: 100%"
                      ...
                      ref="jcjs_table"
                      :default-sort = "{prop: 'base_NEET_ID', order: 'descending'}"
                      @row-click="handleCurrentChange">
              <el-table-column sortable prop="base_NEET_ID" label="需求编号" width="200" show-overflow-tooltip></el-table-column>
              <el-table-column sortable prop="neel_NAME" label="需求名称" width="160" show-overflow-tooltip></el-table-column>
              ...
              <el-table-column sortable prop="end_DATE" :formatter="tableFormatter_end" label="期望上线日期" width="130"
                               show-overflow-tooltip></el-table-column>
              ...
              <el-table-column sortable prop="rriority_NAME" label="优先级" width="100" show-overflow-tooltip></el-table-column>
              ...
              <el-table-column label="操作" fixed="right" width="230">
                <template slot-scope="scope">
                  ...
                  <el-button size="mini" type="primary"
                         ...
                         @click="tableAction(scope.$index, scope.row, $event, 'J_split')">拆分任务
                  </el-button>
                  <el-button size="mini" type="primary"
                    ...
                    <el-row :gutter="20">
                      ...
                      <el-col :span="12" v-if="tabs.tabsData.oldcode">
                        <el-form-item label="原需求编号">
                          <span @click="goNeedList($event,tabs.tabsData.oldcode,'old')"
                                style="color: #ffa005;cursor: pointer;">{{tabs.tabsData.oldcode}}</span>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12" v-if="tabs.tabsData.newcode">
                        <el-form-item label="新需求编号">
                          <span @click="goNeedList($event,tabs.tabsData.newcode,'new')"
                                style="color: #ffa005;cursor: pointer;">{{tabs.tabsData.newcode}}</span>
                        </el-form-item>
                      </el-col>

                      <el-col :span="12">
                        <el-form-item label="需求编号">{{tabs.tabsData.base_NEET_ID}}</el-form-item>
                      </el-col>
                      <el-col :span="12">
                      ...
                      <el-col :span="12">
                        <el-form-item label="需求来源">{{tabs.tabsData.dept_NAME}} | {{tabs.tabsData.user_NAME}}
                        </el-form-item>
                      </el-col>
                      <el-col :span="12">
                      ...
                      <el-col :span="24" v-if="addneeds.hasUploadFile.length">
                        <el-form-item label="需求文档">
                          <span @click="showDownLoadData(addneeds.hasUploadFile,'需求文档')"
                                style="cursor: pointer;color: red">点击查看</span>
                        </el-form-item>
                      </el-col>
                      <!---------------------------原产品改造点和产品描述-->
                      ...
                      <el-col :span="24">
                        <el-form-item label="当前用例">
                          <span style="cursor: pointer;color: orangered"
                                @click="showDownLoadData('','当前用例')">点击可查看</span>
                        </el-form-item>
                      </el-col>
                      <!------------------------------开发手册-->
                      <el-col :span="24">
                        <el-form-item label="开发手册">
                          <span style="cursor: pointer;color: orangered"
                                @click="showDownLoadData('','开发手册')">点击可查看</span>
                        </el-form-item>
                      </el-col>
                  ...
                  <div v-if="split.splitvisible">
                    ...
                    <div class="table-list">
                      <el-table :data="split.tableData" border style="width: 100%">
                        ...
                        <el-table-column prop="BASE_INFO_ID" label="任务编码" show-overflow-tooltip></el-table-column>
                        <el-table-column prop="end_data_format" label="完成日期" width="120"
                                         show-overflow-tooltip></el-table-column>
                    ...
                    <el-row :gutter="20">
                      <el-col :span="12">
                        <el-form-item label="评审等级">
                          <el-select v-model="ifPing.rriority" filterable clearable placeholder="请选择评审等级"
                                     style="width: 100%">
                            <el-option v-for="(item, index) in ifPing.rriorityArr" :label="item.RRIORITY_NAME"
                                       :key="index"
                      ...
                      <el-col :span="12">
                        <el-form-item label="需求评审结果">
                          <el-select v-model="ifPing.checks" filterable clearable placeholder="请选择需求评审结果"
                                     style="width: 100%">
                            <el-option v-for="(item, index) in ifPing.checksArr" :label="item.CHECK_NAME" :key="index"
                  ...
                  <div v-if="hang.hangvisible">
                    <div class="table-list" style="margin-top: 30px;">
                      <el-table :data="hang.hangtableData" height="280" border
                        ...
                        <el-table-column prop="facility_NAME" label="难易度" width="80"
                                         show-overflow-tooltip></el-table-column>
                          ...
                          <template slot-scope="scope">
                            <div style="text-align: center">
                              ...
                              <div v-if="tabs.activeTableInfo.state_ID != 320">
                                ...
                                <el-button type="primary" size="mini"
                                           v-if="scope.row.sign == 1 && scope.row.state_ID != 319"
                                           @click="transferAction(scope.row,scope.$index)">转接
                                </el-button>
                                <el-button type="primary" size="mini"
                              ...
                              <el-button type="primary" size="mini"
                                         ...
                                         @click="editTaskUseTime(scope.row,scope.$index)">编辑
                              </el-button>
                            </div>
                          </template>
                        </el-table-column>
                    ...
                    <el-row :span="24" :gutter="20" style="margin-top: 20px;">
                      ...
                      <el-col :span="12" :md="12">
                        <el-form-item label="需求分析结果">
                          <el-select v-model="review.result" filterable clearable placeholder="请选择需求分析结果"
                                     style="width: 100%;">
                            <el-option v-for="(item, index) in review.resultArr" :label="item" :value="item"
                                       :key="index"></el-option>
                          </el-select>
                        </el-form-item>
                      </el-col>
                  ...
                  <div v-if="changeInset.visible">
                    ...
                    <div class="table-list">
                      <el-table :data="changeInset.tableData" border style="width: 100%">
                        ...
                        <el-table-column prop="user_NAME" label="人员" show-overflow-tooltip></el-table-column>
                        <el-table-column prop="base_INFO_ID" label="任务编码" width="190"
                                         show-overflow-tooltip></el-table-column>
                        ...
                        <el-table-column prop="end_DATE" :formatter="changeInsetMatter" label="原完成日期" width="120"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column prop="now_end_DATE" :formatter="changeInsetMatter_now" label="现完成日期"
                                         width="120" show-overflow-tooltip></el-table-column>
                        <el-table-column prop="responsible_MODULE" label="原负责模块" width="120"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column prop="now_responsible_MODULE" label="现负责模块" width="120"
                                         show-overflow-tooltip></el-table-column>
                        ...
                        <el-table-column prop="required_TIME" label="原预计用时（小时）" width="100"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column prop="old_REQUIRED_TIME" label="现预计用时（小时）" width="100"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column prop="work_TIME" label="原实际用时（小时）" width="100"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column prop="old_ACTUAL_TIME" label="现实际用时（小时）" width="100"
                                         show-overflow-tooltip></el-table-column>
                        <el-table-column prop="actual_TIME" label="总工时" width="100"
                                         show-overflow-tooltip></el-table-column>
                ...
                <div class="console-tab-content">
                  <div class="table-list" v-if="split.codetask">
                    <div class="clear">
                      ...
                      <!--上传手册-->
                      <el-button style="float: left;margin: 10px" type="primary" size="mini"
                                 @click="startUpload('上传手册')">上传手册
                      </el-button>
                    </div>
                    <el-table :data="split.codetask" border style="width: 100%">
                      <el-table-column prop="user_NAME" label="人员" width="80"></el-table-column>
                      <el-table-column prop="old_SYSTEM_NAME" label="原系统名" show-overflow-tooltip
                      ...
                      <el-table-column prop="end_DATE" :formatter="splitDataFormatter" show-overflow-tooltip
                                       label="完成日期" width="120"></el-table-column>
                      <el-table-column prop="old_RESPONSIBLE_MODULE" label="原负责模块" width="120"
                                       show-overflow-tooltip></el-table-column>
                      <el-table-column prop="responsible_MODULE" label="当前负责模块" width="120"
                                       show-overflow-tooltip></el-table-column>
                ...
                <div class="console-tab-content">
                  ...
                  <div v-if="testTask.hasTask">
                    <div class="clear" style="margin: 20px 0;">
                      ...
                      <!--bug清单-->
                      <el-button class="fr" type="primary" size="mini" @click="showTestAllBug"
                                 style="margin-left: 10px;">BUG清单
                      </el-button>
                      <!--上传测试报告-->
                      ...
                      <div class="table-list" v-if="testTask.testSplitData.length >0"
                        ...
                        <el-table :data="testTask.testSplitData" border style="width: 100%"
                          ...
                          <el-table-column prop="base_INFO_ID" label="任务编码"
                                           width="200"></el-table-column>
                          <el-table-column prop="end_DATE" :formatter="splitDataFormatter" width="120"
                          ...
                          <el-table-column label="操作" width="180">
                            <template slot-scope="scope">
                              <div style="text-align: center">
                                ...
                                <el-button size="mini" type="primary"
                                           style="float: none;display: inline-block"
                                           @click="splitTaskFinish(scope.$index, scope.row,'test')"
                      ...
                      <el-col :span="6" :sm="6">
                        <el-form-item>
                          <el-button size="mini" type="primary" @click="loadtrack">
                            {{tracking.trackingvisiible?'列表模式':'视图模式'}}
                          </el-button>
                        </el-form-item>
                      </el-col>
                      <el-col :span="6" :sm="6">
                        <el-form-item>
                          <el-select size="mini" v-model="tabs.genzongchoosen" filterable clearable
                                     placeholder="请选择筛选部门"
                                     style="width: 100%" @change="genzongChange">
                            <el-option v-for="(item, index) in tabs.genzongArr" :label="item.DEPT_NAME" :key="index"
                ...
                <div class="console-tab-content">
                  <el-tabs v-model="sstj.activeName" class="sstabs" style="width: 100%;height: 100%">
                    <el-tab-pane label="周期" name="first" clearable>
                      ...
                      <div v-show="!sstj.hidezqvisible" id="system" clearable
                           style="width:1000px;height: 200px;margin: 20px 0;"></div>
                    </el-tab-pane>
        ...
        <el-row :md="24" :gutter="20">
          ...
          <el-col :span="12" :md="12">
            <el-form-item label="需求类型">
              <el-select filterable clearable :disabled="addneeds.addType == 'changeInset'"
                         ...
                         placeholder="请选择需求类型"
                         style="width: 100%">
                <el-option :key="index" v-for="(item, index) in addneeds.addform.needstypeArr"
                           :label="item.NEEL_TYPE_NAME"
          ...
          <el-col :span="12" :md="12">
            <el-form-item label="成果类型">
              <el-select :disabled="addneeds.addType == 'changeInset'" v-model="addneeds.addform.resulttype" filterable
                         clearable placeholder="请选择成果类型"
                         style="width: 100%">
          ...
          <el-col :span="12" :md="12">
            <el-form-item label="优先级评定">
              <el-select :disabled="addneeds.addType == 'changeInset'" v-model="addneeds.addform.level" filterable
                         clearable placeholder="请选择优先级"
                         style="width: 100%;">
          ...
          <el-col :span="12" :md="12">
            <el-form-item label="需求划分归属">
              <el-select :disabled="addneeds.addType == 'changeInset'" v-model="addneeds.addform.attribution" filterable
                         clearable placeholder="请选择需求划分归属"
                         style="width: 100%;">
          ...
          <el-col :span="12" :md="12">
            <el-form-item label="重要程度">
              <el-select :disabled="addneeds.addType == 'changeInset'" v-model="addneeds.addform.zhongyaochegndu"
                         filterable clearable placeholder="请选择重要程度"
                         style="width: 100%;">
          ...
          <el-col :span="12" :md="12">
            <el-form-item label="需求提出人">
              <el-select :disabled="addneeds.addType == 'changeInset'" v-model="addneeds.addform.fromdeptroleId"
                         filterable clearable placeholder="请选择人员"
                         style="width: 100%;">
                <el-option :key="index" v-for="(item, index) in addneeds.addform.fromdeptroleArr"
          ...
          <el-col :span="24" :md="24">
            <el-form-item label="是否加急" style="height: 42px">
              <el-row :span="24">
                <el-col :span="6" :md="6">
                  <el-radio v-model="addneeds.addform.jiaji" label="0" :disabled="addneeds.addType == 'changeInset'">否
                  </el-radio>
                  <el-radio v-model="addneeds.addform.jiaji" label="1" :disabled="addneeds.addType == 'changeInset'">是
                  </el-radio>
                </el-col>
                <el-col :span="18" :md="18">
                  <el-input placeholder="请填写加急原因" :disabled="addneeds.addType == 'changeInset'"
                            v-model="addneeds.addform.jiajireason"
          ...
          <el-col :span="24" :md="24">
            <el-form-item label="产品改造点">
              ...
              <v-vueQuillEditor-changepoint :changepoint="addneeds.addform.changepoint"
                                            @setValue="setValue_changepoint">
            ...
            <el-form-item label="上传需求文档">
              ...
              <p :key="index" v-for="(item,index) in addneeds.uploadFiles">{{item.name}}
                <i style="margin-left: 10px;cursor: pointer;color: red;"
                   @click="addneeds.fileIds.splice(index,1);addneeds.uploadFiles.splice(index,1)"
    ...
    <el-dialog :close-on-click-modal="false" title="新增拆分任务人员" :visible="split.splitaddvisible" width="60%"
      ...
      <el-form label-width="100px">
        ...
        <el-form-item label="系统名">
          <el-col :span="24">
            <el-radio v-model="split.splitradio" label="1" @change="split.choosesystem = '';split.choosesystemSub = '';split.levelchoosen = '';">测试任务</el-radio>
            <el-radio v-model="split.splitradio" label="2" @change="split.choosesystem = '';split.choosesystemSub = '';split.levelchoosen = '';">开发任务</el-radio>
    ...
    <el-dialog :close-on-click-modal="false" title="当前BUG" :visible="testTask.codeBUGlistvisible"
      ...
      <el-dialog :close-on-click-modal="false" title="请选择转接人员" :visible="testTask.assignvisible_code" width="40%"
        ...
        <el-select v-model="testTask.assignPerson_code" filterable clearable placeholder="请选择"
      ...
      <el-form label-width="100px">
        ...
        <el-form-item label="上传BUG附件">
          ...
          <p :key="index" v-for="(item,index) in testTask.uploadBugFiles">{{item.name}}
            <i style="margin-left: 10px;cursor: pointer;color: red;"
               @click="testTask.uploadBugFiles.splice(index,1);testTask.fileIds.splice(index,1)"
               class="el-icon-close"></i>
          </p>
        </el-form-item>
      </el-form>
    ...
    <el-dialog :close-on-click-modal="false" title="BUG清单" :visible="testTask.allbugvisible" width="80%"
      ...
      <div class="table-list">
        <el-table :data="testTask.allbuglist" border style="width: 100%">
          ...
          <el-table-column prop="problem_DESCRIPTION" label="问题描述" show-overflow-tooltip></el-table-column>
          <el-table-column prop="first_PERSON_NAME" label="指派人" show-overflow-tooltip></el-table-column>
          <el-table-column prop="assignor_PERSON_NAME" width="120" label="当前执行人"
                           show-overflow-tooltip></el-table-column>
          <el-table-column prop="user_NAME" label="完成人" show-overflow-tooltip></el-table-column>
          <el-table-column label="附件">
            <template slot-scope="scope">
...
//                let card_header_height = document.querySelector(".el-card__header").offsetHeight;
      ...
      uploadneeds(e){
        ...
        this.$axios.post("/base/uploadNell", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
            this.$success("上传成功！");
...
//                this.addneeds.addform.fromdeptroleArr = [];
      ...
      subaddForm(){
        ...
        this.$maskin();
        let params = new URLSearchParams();
        console.log(this.addneeds.addform)
        ...
        params.append("USER_ID", this.addneeds.addform.fromdeptroleId);//需求提出人ID
        let userName;
        ...
        params.append("SEND_NAME", userName);//需求提出人名字
        ...
        if (this.addneeds.addType == "change") {
          ...
          //需求内变更
          url = "/base/innerUpdate";
//                    params.append("BASE_NEET_FID",this.addneeds.addform.oldcode);
        } else if (this.addneeds.addType == "edit") {
          //修改编辑
          url = "/base/updateBaseByApply";
        }
...
//            type:"category",
      ...
      loadAllBugs(){
        ...
        this.$axios.post("/base/queryBugByNeel", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
      ...
      startUpload(type){
        ...
        this.uploadAction.neel_id = this.tabs.activeTableInfo.base_NEET_ID;
      ...
      showDownLoadData(val, title, row){
        if (title == "BUG附件") {
          let params = new URLSearchParams();
          params.append("BUG_ID", row.base_BUG_ID);
        ...
        if (val == "") {
          ...
          this.$axios.post("/base/queryFileByType", params).then((res) => {
            let data = res.data;
            if (data.code = 200) {
              this.$set(this.download, "data", data.result);
              this.download.title = title;
      ...
      consoleActionEvent(val, scope=undefined, e=undefined){
        ...
        if(!this.tabs.activeTableInfo.base_NEET_ID) this.tabs.activeTableInfo.base_work_NEET_ID = scope.base_NEET_ID;
        ...
        switch (val.type) {
          ...
          case 'POSTPONE_REVIEW':
            // 延后评审
            val.url = 'base/postponeReview';
            this.taskClick(val);
            break;
          case 'INVALID':
            // 无效
            val.url = 'base/invalid';
            this.taskClick(val);
            break;
        }
      },
      ...
      taskClick(val){
        ...
        this.$confirm(`执行 ${val.name} 操作, 是否继续?`, '提示', {
          ...
          this.$maskin();
          let params = new URLSearchParams();
          params.append("BASE_NEEL_ID", this.tabs.activeTableInfo.base_NEET_ID);
      ...
      editNeed(row){
        this.$maskin();
        let params = new URLSearchParams();
        params.append("BASE_ID",row? row.base_NEET_ID: this.tabs.activeTableInfo.base_NEET_ID);
        this.$axios.post("/base/updateBaseFront", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
      ...
      loadHangData(){
        ...
        let params = new URLSearchParams();
        params.append("BASE_ID", this.tabs.activeTableInfo.base_NEET_ID);
        this.$axios.post("/base/querySplitInfo", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
      ...
      //sing:0挂起，1恢复
      hangAction(val){
        this.hang.task_id = val.base_INFO_ID;
      ...
      hangsub(){
        ...
        params.append("BASE_INFO_ID", this.hang.task_id);//任务ID
        params.append("BASE_ID", this.tabs.activeTableInfo.base_NEET_ID);//需求ID
        params.append("SYSTEM_NAME", this.hang.systemName);//系统名
        this.$axios.post("/base/signInfo", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
            this.hang.usetime = "";
            this.hang.reason = "";
      ...
      restore(row){
        ...
        let params = new URLSearchParams();
        params.append("BASE_ID", this.tabs.activeTableInfo.base_NEET_ID);
        params.append("BASE_INFO_ID", row.base_INFO_ID);
//                params.append("SYSTEM_NAME",row.system_NAME?row.system_NAME:"");
        this.$axios.post("/base/signReject", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
            this.$success("操作成功！");
            this.loadHangData();
      ...
      transferAction(row){
        ...
        this.$axios.post("/base/queryPersonByDept", params).then((res) => {
          ...
          if (data.code == 200) {
            ...
            this.transfer.task_id = row.base_INFO_ID;
      ...
      transferSub(){
        ...
        this.$axios.post("/base/updateTaskPerson", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
            //清除数据
      ...
      editTaskUseTime(row, index){
        let task_id = row.base_INFO_ID;//任务ID
        this.prompt("编辑实际用时", "请填写实际用时", (value) => {
          ...
          params.append("BASE_ID", this.tabs.activeTableInfo.base_NEET_ID)
          this.$axios.post("/base/editSplitTask ", params).then((res) => {
            let data = res.data;
            if (data.code == 200) {
              this.loadHangData();
            }
      ...
      subPing(){
        ...
        this.$maskin();
        let params = new URLSearchParams();
        params.append("BASE_NEET_ID", this.tabs.activeTableInfo.base_NEET_ID);
        ...
        this.$axios.post("/base/reviewBase", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
            this.$success("操作成功！");
            this.clearPingData()
      ...
      beginreview(){
        this.$maskin();
        let params = new URLSearchParams();
        this.$axios.post("/base/personCheckFront", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
      ...
      //  if(start>=end){
       ...
       // }
        ...
        this.$axios.post("/base/personCheck", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
            this.$success("操作成功！");
            let review = this.review;
      ...
      acceptSub(params){
        let apiPath = '';
        if ([329, 330].indexOf(this.tabs.activeTableInfo.state_ID) > -1) {
          apiPath = '/base/prodCheck';
        } else {
          apiPath = '/base/baseAccept';
        }
      ...
      newchange(type){
        ...
        // params.append("BASE_NELL_ID", this.tabs.activeTableInfo.base_work_NEET_ID);
...
//                this.addneeds.addform.needsname = info.neel_DESCRIPTION;//需求描述
      ...
      getAssign(){
        ...
        this.myurl = "/base/queryUserByDemand";
...
//                }
      ...
      splitPersonChangeEvent(){
        ...
        this.$axios.post("/base/spiltCheck", params)
      },
      //-----------------------------------拆分任务新增人员确定操作
      splitPersonSub(){
...
//            },
      ...
      splitTaskFinish(index, val, type){
        ...
        this.$maskin();
        let params = new URLSearchParams();
        params.append("TEST_INFO_ID", val.base_INFO_ID);
        this.$axios.post("/base/checkTestConfrim", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
            let msg = "";
            if (data.result) {
            ...
            this.taskFinished.taskId = val.base_INFO_ID;//当前任务ID
...
//                            }, ["通过", "不通过"]);
      ...
      testTaskNotAllow(val, index){
        ...
        let params = new URLSearchParams();
        this.$axios.post("/base/queryPerson", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
      ...
      uploadBUG(e){
        ...
        params.append("token", this.$getToken());
        params.append("file", file);
        this.$axios.post("/base/uploadTest", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
            this.$success("上传成功");
      ...
      doTestAssignBug(){
        ...
        let params = new URLSearchParams();
        params.append("BASE_ID", this.tabs.activeTableInfo.base_NEET_ID);//需求ID
        params.append("TEST_INFO_ID", this.testTask.testTaskActiveInfo.base_INFO_ID);//任务ID;
      ...
      showTestAllBug(){
        ...
        let params = new URLSearchParams();
        params.append("BASE_ID", this.tabs.activeTableInfo.base_NEET_ID);
        this.$axios.post("/base/queryBugByTest", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
      ...
      testBUGAction(index, row, type){
        ...
        this.$axios.post("/base/updateBugStateByTest", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
      ...
      showTestReportUpload(){
        ...
        this.testReport.neel_id = this.tabs.activeTableInfo.base_NEET_ID;
      ...
      doChangeInset(){
        ...
        let params = new URLSearchParams();
        params.append("BASE_ID", this.tabs.activeTableInfo.base_NEET_ID);
        this.$axios.post("/base/confrimInnerCheck", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
...
//                this.changeInset.truetime = "";//实际用时
      ...
      changeInsetPersonSub(){
        ...
        let obj = {
          BASE_INFO_ID: this.changeInset.taskcode,//任务编号
      ...
      subChangeInset(){
        ...
        params.append("BASE_ID", this.tabs.activeTableInfo.base_NEET_ID);
        this.$axios.post("/base/updateInfos", params).then((res) => {
          let data = res.data;
          if (data.code == 200) {
            this.$success("操作成功！");
            this.loadData();
      ...
      pageHandler(handlerType){
        ...
        if(handlerType === 'home'){
          ...
          params.append('page',this.currentPageNumber)
          params.append('pageSize',this.defaultPageSize)
          return this.$axios.post("/base/queryAll",params).then((res)=>{
            let data = res.data;
            if(data.code == 200){
              this.current_user_id = data.result.current_user_id;
